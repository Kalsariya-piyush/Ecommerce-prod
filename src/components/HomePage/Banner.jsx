    ...
    <div className="my-16">
      <div className="max-w-7xl mx-auto text-gray-900">
        <div className="grid lg:place-items-stretch place-items-center justify-center lg:gap-y-0 gap-y-5 lg:gap-x-6 gap-x-1 sm:grid-cols-2 grid-cols-1">
          <div className="bg-gray-50 lg:p-10 p-5 rounded-[6px]">
            <div className="flex items-center gap-x-5 lg:flex-row flex-col">
              <div className="flex flex-col items-start gap-y-3 lg:order-1 order-2">
                <Button className="bg-secondary-500 hover:bg-secondary-500 uppercase py-1.5 px-3 rounded-sm text-sm text-white font-semibold lg:mt-0 mt-3">
                  introducing
                </Button>
                ...
                <div className="text-base text-disabled-500">
                  <p>Jam-packed with innovation,</p>
                  <p> HomePod mini delivers unexpectedly.</p>
                </div>

                <Button className="uppercase rounded-sm px-4 text-white  text-sm flex items-center gap-x-2 font-semibold leading-9 bg-primary-500 hover:bg-primary-500">
          ...
          <div className="rounded-[6px] bg-gray-900">
            <div className="flex items-end justify-between gap-x-5 lg:flex-row flex-col">
              <div className="lg:p-10 p-5 flex flex-col items-start lg:gap-y-3 gap-y-2 lg:order-1 order-2">
                <Button className="bg-warning-400 hover:bg-warning-400 uppercase py-1.5 px-3 rounded-sm text-sm text-black font-semibold">
                  introducing new
                </Button>
                ...
                <Button className="uppercase rounded-sm px-4 text-white lg:top-3  text-sm flex items-center gap-x-2 font-semibold leading-9 bg-primary-500 hover:bg-primary-500">
                  shop now <RightArrowIcon />
                </Button>
              </div>
