        ...
        <div className="bg-primary-100">
          <div className="flex justify-between items-center lg:flex-row flex-col">
            <div className="lg:px-14 px-0 py-0 flex flex-col items-start gap-y-4 lg:order-1 order-2 lg:pb-0 pb-8">
              <Button className="bg-secondary-500 hover:bg-secondary-500 uppercase py-1.5 px-3 rounded-sm text-sm text-white font-semibold">
                save upto $200
              </Button>
              ...
              <Button className="uppercase rounded-sm px-8 text-white   text-sm flex items-center gap-x-2 font-semibold leading-10 hover:bg-primary-500 bg-primary-500">
