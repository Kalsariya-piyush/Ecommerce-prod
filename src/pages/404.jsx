  ...
  return (
    <div className="max-w-7xl mx-auto text-gray-900">
      <div className="flex flex-col justify-center items-center h-[90vh]">
        ...
        <div className="flex flex-col gap-y-6 text-center xs:mx-0 mx-3">
          ...
          <div className="flex items-center gap-x-4 mx-auto">
            <Button
              variant="contained"
              className="group uppercase rounded-sm sm:px-4 px-2 text-sm text-white right-4 flex items-center gap-x-2 font-semibold leading-7 bg-primary-500"
            >
            ...
            <Button
              ...
              variant="outlined"
              color="warning"
              className="text-sm font-semibold border  p-2 flex items-center gap-x-1 sm:px-4 px-2  text-primary-500 uppercase"
            >
              <span>
                <HomeIcon />
              </span>
