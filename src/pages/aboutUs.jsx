...
export const aboutUs = () => {
  ...
  let arr2 = [
    {
      id: 1,
      image: "assets/AboutProducts/b1.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 2,
      image: "assets/AboutProducts/b2.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 3,
      image: "assets/AboutProducts/b3.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
  ...
  let arr3 = [
    {
      id: 1,
      image: "assets/AboutProducts/c1.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 2,
      image: "assets/AboutProducts/c2.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 3,
      image: "assets/AboutProducts/c3.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
  ...
  let arr4 = [
    {
      id: 1,
      image: "assets/AboutProducts/d1.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 2,
      image: "assets/AboutProducts/d2.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
    {
      id: 3,
      image: "assets/AboutProducts/d3.png",
      company: "Bose Sport Earbuds - Wireless",
      model: " Earphones - Bluetooth In Ear...",
      price: "$1,500",
    },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex lg:flex-row flex-col items-center lg:justify-between justify-start xl:mx-0 mx-3">
            <div className="lg:w-1/2 smz:w-[500px] w-auto   order-2 lg:order-1">
              <Button variant="contained" className="bg-secondary-500 hover:bg-secondary-500 px-4 py-2 rounded-sm my-2 lg:mt-0 mt-4 text-white font-semibold">
                WHO WE ARE
              </Button>
            ...
            <div className="order-1 lg:order-2">
              <img
                src="/assets/Temp/image_2024_01_18T12_05_59_942Z.png"
                alt=""
                width={500}
                height={500}
              />
      ...
      <div className="my-16 text-gray-900 capitalize">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-5 xl:mx-0 mx-3">
            {TeamMember.map(({ image, name, designation },index) => (
              <div key={index} className="flex items-center  border border-gray-100  p-6 rounded-sm gap-x-4 boxShadow-secondary">
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col justify-center h-96">
              ...
              <div className="my-3">
                <p className="text-lg">Praesent sed semper metus. Nunc aliquet dolor</p>
                <p className="text-lg">mauris, et fringilla elit gravida eget. Nunc</p>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-5 xl:mx-0 mx-3">
            <div className="">
              ...
              <div className="flex flex-col  justify-center gap-y-3 ">
                {arr1.map(({ image, product, model, price },index) => (
                  <div key={index} className="flex items-center gap-x-2.5  border border-gray-100  p-3 rounded-sm  boxShadow-secondary">
                    <img src={image} alt="" height={64} width={64} />
                    <div className="leading-5">
                      <p className="font-semibold text-base">{product}</p>
                      <p className="font-semibold text-base">{model}</p>
                      <p className="text-secobg-secondary-500] font-semibold">{price}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="">
              ...
              <div className="flex flex-col  justify-center gap-y-3 ">
                {arr2.map(({ image, product, model, price },index) => (
                  <div key={index} className="flex items-center gap-x-2.5  border border-gray-100  p-3 rounded-sm  boxShadow-secondary">
                    <img src={image} alt="" height={64} width={64} />
                    <div className="leading-5">
                      <p className="font-semibold text-base">{product}</p>
            ...
            <div className="">
              ...
              <div className="flex flex-col  justify-center gap-y-3 ">
                {arr3.map(({ image, product, model, price },index) => (
                  <div key={index} className="flex items-center gap-x-2.5  border border-gray-100  p-3 rounded-sm  boxShadow-secondary">
                    <img src={image} alt="" height={64} width={64} />
                    <div className="leading-5">
                      <p className="font-semibold text-base">{product}</p>
            ...
            <div className="">
              ...
              <div className="flex flex-col  justify-center gap-y-3 ">
                {arr4.map(({ image, product, model, price },index) => (
                  <div key={index} className="flex items-center gap-x-2.5  border border-gray-100  p-3 rounded-sm  boxShadow-secondary">
                    <img src={image} alt="" height={64} width={64} />
                    <div className="leading-5">
                      <p className="font-semibold text-base">{product}</p>
        ...
        <div className="py-16">
          <div className="flex flex-col items-center">
            <div className="text-white text-center">
              ...
              <p className="text-base text-gray-400">Praesent fringilla erat a lacinia egestas. Donec vehicula tempor libero state</p>
              <p className="text-base text-gray-400"> cursus. Donec non quam urna. Quisque vitae porta ipsum.</p>
            </div>
            ...
            <div className="border border-t-gray-600 w-80"></div>
